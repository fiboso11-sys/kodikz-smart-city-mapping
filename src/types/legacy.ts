/** Legacy simulator-era types — retained for Phase 2 module stubs. */

export type VehicleTypeLegacy =
  | "SUV"
  | "Pickup"
  | "Van"
  | "Truck"
...
/** @deprecated Use PermitMaster from ./permit */
export type Permit = PermitLegacy;
